...
- (id)initWithViewController:(FFTTViewController *)viewController
{
    ...
    if (self) {
        ...
        self.audioFilePlayer = [AEAudioFilePlayer audioFilePlayerWithURL:[[NSBundle mainBundle] URLForResource:@"Samples/A3s" withExtension:@"aiff"] audioController:self.audioController error:nil];
